...
export const breachData: BreachData[] = [
  ...
  },
  {
    ...
    {
    id: "Cyryx_College",
    logo: "/haveibeenpwnedmv/logos/Cyryx_College.png",
    service: "Cyryx College",
    category: "Education",
    discoveredDate: "2026",
    patchedDate: "2026",
    affectedUsers: Affected.ALL_REGISTERED,
    questions: ["Did you ever apply to Cyryx?"],
    dataTypes: ["Names","School Certs","NID Copy","Current Address","Parents Details", "Permanent addresses", "Phone numbers"],
    description:
      "Unsecured API endpoint exposed all application details",
    severity: Severity.CRITICAL,
  },
  {
    id: "villa_logo",
    logo: "/haveibeenpwnedmv/logos/villa_logo.png",
    service: "Villa College/HighSchool",
    category: "Education",
    discoveredDate: "2026",
    patchedDate: "2026",
    affectedUsers: Affected.ALL_REGISTERED,
    questions: ["are you a student of villa from 2023 to 2026?"],
    dataTypes: ["Names", "Photo"],
    description:
      "Unsecured API endpoint exposed student images and names. Villa denied any breeches and patched the api",
    severity: Severity.MEDIUM,
  },
    {
    id: "hajjcorp",
    logo: "/haveibeenpwnedmv/logos/hajjcorp.png",
    service: "Hajj Corp",
    category: "Government",
    discoveredDate: "2026",
    patchedDate: "2026",
    affectedUsers: Affected.ALL_REGISTERED,
    questions: ["Did you ever apply to Hajj Corp?"],
    dataTypes: ["Names","NID Copy","Current Address","Parents Details", "Permanent addresses", "Phone numbers"],
    description:
